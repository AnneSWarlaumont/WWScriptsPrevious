...
setwd("/Users/ginapretzer/Desktop/WWScripts/Reliability/")
  ...
  m2 = m2[c("Master")]
  m3 = read.table("WW20_Master_Annotation_File_AUD.txt", col.names = c("start", "end", "Master")) 
  m3 = m3[c("Master")]
  m4 = read.table("WW23_Master_Annotation_File_AUD.txt", col.names = c("start", "end", "Master")) 
  m4 = m4[c("Master")]
  m5 = read.table("WW60_Master_Annotation_File_AUD.txt", col.names = c("start", "end", "Master")) 
  m5 = m5[c("Master")]
  m6 = read.table("WW62_Master_Annotation_File_AUD.txt", col.names = c("start", "end", "Master"))
  m6 = m6[c("Master")]
  ...
  write.table(fulldf1, "masterListAUD.txt", quote=FALSE, row.names = FALSE, col.names = FALSE)
  ...
  r2 = read.table("WW16_AF_Reliability_Check_AUD.txt", col.names = c("start", "end", "Reliability_Check"))
  r2 = r2[c("Reliability_Check")]
  r3 = read.table("WW20_AF_Reliability_Check_AUD.txt", col.names = c("start", "end", "Reliability_Check"))
  r3 = r3[c("Reliability_Check")]
  r4 = read.table("WW23_AF_Reliability_Check_AUD.txt", col.names = c("start", "end", "Reliability_Check"))
  r4 = r4[c("Reliability_Check")]
  r5 = read.table("WW60_AF_Reliability_Check_AUD.txt", col.names = c("start", "end", "Reliability_Check"))
  r5 = r5[c("Reliability_Check")]
  r6 = read.table("WW62_AF_Reliability_Check_AUD.txt", col.names = c("start", "end", "Reliability_Check"))
  r6 = r6[c("Reliability_Check")]
  
  #list reliability check data in one data frame
  fulldf2 = rbind(r1, r2, r3, r4, r5, r6)

  write.table(fulldf2, "reliabilityListAUD.txt", quote=FALSE, row.names = FALSE, col.names = FALSE)
